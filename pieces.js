...
function createCardHolders() {
  return [
    { id: "holder-1", x: 479, y: 50,  width: 660, height: 80 },
    { id: "holder-2", x: 479, y: 175, width: 660, height: 80 },
    { id: "holder-3", x: 479, y: 300, width: 660, height: 80 },
    { id: "holder-4", x: 479, y: 425, width: 660, height: 80 },
    { id: "holder-5", x: 479, y: 550, width: 660, height: 80 },
    { id: "holder-6", x: 400, y: 690, width: 800, height: 65 },
  ];
}
...
const sections = [
  ...
  },
  {
    ...
    pieces: [
      ...
      ...createPiecesFromDefinition({
        group: "Marker-special",
        name: "marker-special-eql",
        labels: ["="],
        width: 30,
        height: 30,
        frontFill: "#2d6cdf",
